			...
			for p in range(len(rels)):
				...
				for q in range(len(rels)):
					...
					if (p != q) and ((aLabel == aLabel_2) or (bLabel == bLabel_2)):
						...
						samples.append({"p":p, "imPath": path, "rLabel": rLabel, "aLabel": aLabel, "bLabel": bLabel, "rBBox": rBBox, "aBBox": aBBox, "bBBox": bBBox,
							"q":q, "rLabel_2": rLabel_2, "aLabel_2": aLabel_2, "bLabel_2": bLabel_2, "rBBox_2": rBBox_2, "aBBox_2": aBBox_2, "bBBox_2": bBBox_2})
						self._sampleIdx += 1	
